    ...
    <div class="info-content">
      <section class="section">
        ...
        <div class="delivery">
          <div>
            ...
            <span>由{{info.description}}提供配送，约{{info.deliveryTime}}分钟送达，距离{{info.distance}}m</span>
          </div>
      ...
      <section class="section">
        ...
        <div class="pic-wrapper">
          <ul class="pic-list" :style="{width: info.pics.length*126-6+'px'}" v-if="info.pics">
...
export default {
    mounted(){
        // this.bs_shop= new BetterScroll(".shop-info", {
        //     click: true,
        // })
        // this.bs_pic=new BetterScroll(".pic-wrapper",{
        //     scrollX:true,
        //     scrollY:false,
        //     click: true,
        // })
